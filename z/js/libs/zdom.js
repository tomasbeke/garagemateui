 ...
 function  zdom(){
    ...
    function _registerScoped_(name,val,exporter){
        if(!name){return}
            ...
            if (typeof(name) == "function") {
                ...
                if(Array.isArray(name)){
                    for(var i= 0,l= name ,ln= l.length;i<ln;i++){
                        _registerScoped_(l[i],null,exporter)
                    }
                } else{
                    for(var i= 0,l=Object.keys(name),ln= l.length;i<ln;i++){
                        _registerScoped_(l[i],name[l[i]],exporter)
                    }
                }
                return;
            }
     ...
     function _foreach(o,fn,ctx){
         if(!(o && typeof(o)=="object") || !(fn && typeof(fn)=="function")){return}
         var isarr=Array.isArray(o)||(o instanceof Array)
         for(var i= 0,l=isarr?o:Object.keys(o),k,ln= l.length;k=isarr?i:l[i],i<ln;i++){
             fn.call(ctx,o[k],k,o)
         }
     }
function ODF(o,nm,descriptor){
    if(!o || !nm){return}
    if(descriptor==null && typeof(nm)=="object"){
        _foreach(nm,function(v,k){
            ODF(o,k,v)
        });
        return o
    }
    if(descriptor==null){return}
    if(typeof(descriptor)=="function" && typeof(arguments[3])=="function"){descriptor={get:descriptor,set:arguments[3]}}
    else if(typeof(descriptor)=="function"){descriptor={value:descriptor}}
    if(typeof(arguments[3])=="boolean"){descriptor.enumerable=arguments[3]}
    if(typeof(arguments[4])=="boolean"){descriptor.writable=arguments[4]}
    if(typeof(arguments[5])=="boolean"){descriptor.configurable=arguments[5]}
    if((descriptor.set || descriptor.get) && descriptor.writable!=null){delete descriptor.writable}
    Object.defineProperty(o,nm,descriptor)
    return o
}

        function DOMImpl(execscope,zSelector){
            var $exports = Object.create(null);
            if(execscope==null && typeof(window)=="undefined"&& typeof(self)!="undefined"){
                $exports=self;
            }
            else if (execscope && typeof execscope == 'object') {
                $exports = execscope
            }
            var self=$exports;
            var $export={}
            function _registerScoped(name,val){
                 _registerScoped_(name,val,$exports)
            }
            for(var i= 2,l=arguments,ln= l.length;i<ln;i++){
                _registerScoped(l[i])
            } 
            var doLog= 1,ArrayProto=Array.prototype;
            function _noop(){}

            var pushall=ArrayProto.push,document,window={},selectorEngineImpl=null;
            var util  = (function(){
                var __uid= 0;
            ...
            //DOM Impl
             ...
             function  DOMTokenList(el ){
                this.el=el
                var curr=el.__get("class")
                if(curr){pushall.apply(this,curr.split(/\s+/))}
            }

            DOMTokenList.prototype=Object.create(Array.prototype)
            DOMTokenList.prototype.onchange=function(){ this.el.__set("class",this.join(" "))}
            ...
            NamedNodeMap.prototype.getNamedItem=function(nm){
                ...
                return {name:nm,value:this.el.__get(nm)}
            }
            ...
            ODF(CSSStyleDeclaration.prototype,"cssText",{
                get:function(){
                    if(!this.el){return}
                    var holder=[]
            ...
            var queryMethods={
                ...
                byAttrValue:function(nm,val,parent){
                    var ret=[]
                    traverse(parent._O_ ,function(o,up){
             ...
             function queryAll(selector,parent,count ){
                if(!selectorEngineImpl){
                    selectorEngineImpl=zSelector.getEngine(document)
                }
             ...
             */
             function Node(object,parent){
                ...
                object.ch||(object.ch=[]);
                //hidden core
                 ODF(this,"__inst_",{value:true,enumerable:false,writable:false,configurable:true});
                 ODF(this,"_O_",{value:object,enumerable:false,writable:false,configurable:true}); //{lvl:1,tag: "", attr: {}, ch: []}
                //---

                if(object.tag=="html"){
                    document._O_.ch=[object]
                ...
                if(object.text!=null||object.tag=="#text"||object.tag=="#comment"){
                    this.nodeType=3
                    this._O_.attr={tag:"#text"}
                } else{
                    if(additional[this.nodeName]){
                        ODF(this,additional[this.nodeName])
                    }
                }
            }
            ...
            var nodeProtoprops={
                ...
                __props:{get:function(){
                    if(this.nodeType!==1||!this.__inst_){return null}
                    delete this.__props;
                    var nu=this._O_.attr||(this._O_.attr={});
                    ODF(this,"__props",{value:nu,writable:false,enumerable:false,configurable:true})
                    return nu;
                },
                ...
                attributes:{get:function(){
                    ...
                    ODF(this,"attributes",{value:nu,writable:false,enumerable:true,configurable:true})
                    return nu;
                },
                ...
                tagName:{get:function(){
                    return String(this._O_.tag).toUpperCase()},
                    set:_noop,enumerable:true
                },
                id:{get:function(){return this.nodeType!==1||!this.__inst_?null:this.__get("id")},
                    set:function(id){if(!this.__props||this.nodeType!==1||!this.__inst_){return null}
                        //idCache[id]=this._O_.uniqueId
                        return this.__set("id",id)
                    },enumerable:true
                },
                parentNode:{get:function(){
                    return Node.from(this._O_.par)
                },
                    set:function(p){if(!this.__inst_){return}
                        util.setParent(this ,p)

                    },enumerable:true },

                children:{get:function(){
                    if(this.nodeType!==1||!this.__inst_){return []}
                    var res=[]
                    for(var i= 0,l=this._O_.ch,ln= l.length;i<ln;i++){
                        if(l[i].tag!=="#text"){
                ...
                childElementCount:{get:function() {if(this.nodeType!==1||!this.__inst_){return 0}
                    return this._O_.ch.filter(function(a){return a.nodeType==1}).length
                },set:_noop,enumerable:true
                },
                previousElementSibling:{get:function(){if( !this.__inst_){return null}
                ...
                nextElementSibling:{get:function(){if( !this.__inst_){return null}
                ...
                nextSibling:{get:function(){if( !this.__inst_){return null}
                    var p=Node.from(this._O_.par)
                    if(!p||!p._O_){return null}
                    var ch=p._O_.ch;
                    var i=ch.indexOf(this._O_)
                    return i>=0?Node.from(ch[i+1],p):null

                },set:_noop,enumerable:true },
                previousSibling:{get:function(){if( !this.__inst_){return null}
                    var p=Node.from(this._O_.par)
                    if(!p||!p._O_){return null}
                    var ch=p._O_.ch;
                    var i=ch.indexOf(this._O_)
                ...
                firstChild:{get:function(){
                    if(this.nodeType!==1||!this.__inst_){return null}
                    return Node.from(this._O_.ch[0],this)
                },set:_noop,enumerable:true
                },
                ...
                textContent:{
                    get:function() {if(!this.__inst_){return}
                        return this.nodeType!==1?this._O_.text:this.innerHTML
                    }
                    ,set:function(val){
                        if(!this.__inst_){return}
                        if(this.nodeType!==1){
                            this._O_.text=val
                        } else{
                            this.innerHTML=val;
            ...
            [  "prefix", "shadowRoot", "tabIndex", "title", "translate", "onabort", "onautocomplete", "onautocompleteerror", "onbeforecopy", "onbeforecut", "onbeforepaste", "onblur", "oncancel", "oncanplay", "oncanplaythrough", "onchange", "onclick", "onclose", "oncontextmenu", "oncopy", "oncuechange", "oncut", "ondblclick", "ondrag", "ondragend", "ondragenter", "ondragleave", "ondragover", "ondragstart", "ondrop", "ondurationchange", "onemptied", "onended", "onerror", "onfocus", "oninput", "oninvalid", "onkeydown", "onkeypress", "onkeyup", "onload", "onloadeddata", "onloadedmetadata", "onloadstart", "onmousedown", "onmouseenter", "onmouseleave", "onmousemove", "onmouseout", "onmouseover", "onmouseup", "onmousewheel", "onpaste", "onpause", "onplay", "onplaying", "onprogress", "onratechange", "onreset", "onresize", "onscroll", "onsearch", "onseeked", "onseeking", "onselect", "onselectstart", "onshow", "onstalled", "onsubmit", "onsuspend", "ontimeupdate", "ontoggle", "onvolumechange", "onwaiting", "onwebkitfullscreenchange", "onwebkitfullscreenerror", "onwheel"].forEach(
                function(k){nodeProtoprops[k]={get:Function("return this.__get('"+k+"')"),set:Function("v","return this.__set('"+k+"',v)"),enumerable:true,configurable:true}}
            );
            var additional={
                "input":{
                    "value":{get:Function("return this.__get('value')"),set:Function("v","return this.__set('value',v)"),enumerable:true,configurable:true},
                    "type":{get:Function("return this.__get('type')"),set:Function("v","return this.__set('type',v)"),enumerable:true,configurable:true},
                    "onchange":{get:Function("return this.__get('onchange')"),set:Function("v","return this.__set('onchange',v)"),enumerable:true,configurable:true},
                    "oninput":{get:Function("return this.__get('oninput')"),set:Function("v","return this.__set('oninput',v)"),enumerable:true,configurable:true}
                },
                "img":{
                    "src":{get:Function("return this.__get('src')"),set:Function("v","return this.__set('src',v)"),enumerable:true,configurable:true}
                },
                "iframe":{
                    "href":{get:Function("return this.__get('href')"),set:Function("v","return this.__set('href',v)"),enumerable:true,configurable:true}
                }
            };
            ...
            nodeProtoprops.contentEditable= {get:function(){return this.__get("contentEditable")||"inherit"},set:function(v){return this.__set("contentEditable",v)},enumerable:true,configurable:true}
            nodeProtoprops.draggable={get:function(){return !!this.__get("draggable")},set:function(v){return this.__set("draggable",!v||v=="0"||v=="false"?false:!!v)},enumerable:true,configurable:true}
            nodeProtoprops.isContentEditable= {get:function(){return !!this.__get("isContentEditable");   },set:function(v){return this.__set("isContentEditable",!v||v=="0"||v=="false"?false:!!v)},enumerable:true,configurable:true}
            ...
            Node.prototype.__get=function(name ){
                var p=this.__props;
                if(!p){return null}
                return p[name]
            }
            Node.prototype.__set=function(name,v ){
                var p=this.__props;
                if(!p){return null}
                var curr=p[name]
                if(curr!==v){p[name]=v}
            ...
            Node.prototype.insertBefore=function(child,before){
                if(!child ||!this.__inst_){return null}
                if(!before||!before._O_){return this.appendChild(child)}
                var idx=this._O_.ch.indexOf(before._O_)
                var p=child.parentNode
                if(p){p.removeChild(child)}
                if(idx>=0){
                    this._O_.ch.splice(idx+1,0,child)
                } else{this._O_.ch.push(child)}
                util.setParent(child._O_,this._O_,idx)
                return  child
            }
            Node.prototype.appendChild=function(child){
                ...
                var p=child.parentNode
                if(p){p.removeChild(child)}
                util.setParent(child._O_,this._O_)
                this._O_.ch.push(child._O_)
                return  child
            }
            Node.prototype.contains=function(child){
                if(!child || !child._O_||!this.__inst_){return null}
                var pos=this.compareDocumentPosition(child)
                return pos===16||pos===0
            }
            Node.prototype.compareDocumentPosition=function(other){
                if(!other || !other._O_||!this.__inst_){return null}
                if(this===other){return 0}
                var thispos=this._O_.posIdx,pos=other._O_.posIdx
            ...
            Node.prototype.removeChild=function(child){debugger;
                ...
                var idx=this._O_.ch.indexOf(child._O_)
                if(idx>=0){this._O_.ch.splice(idx,1)}
                child._O_.par=null
                return child
            }
            Node.prototype.getAttribute=function(nm,val){return this.__inst_ && this.__get(nm,true)}
            Node.prototype.setAttribute=function(nm,val){this.__inst_ &&  this.attributes.setNamedItem(nm,val)}
            Node.prototype.removeAttribute=function(nm){if(this.__inst_){return this.attributes.removeNamedItem(nm)}}
            Node.prototype.hasAttribute=function(nm){return  this.__inst_ && nm in this.__props}
            Node.prototype.getElementById = function(id){
                if(!id || !this.__inst_){return null}
                var ret=null
                traverse(this._O_ ,function(o,up){
           ...
           ODF(
                Element.prototype,{
                    ...
                    className:{get:function(){
                        return this.nodeType!==1||!this.__inst_?null:(this.__get("class")||"")},
                        set:function(kls){
                            if(!kls||this.nodeType!==1||!this.__inst_){return}
                            var curr=this.__get("class")||""
                            if(curr.split(/\s+/).indexOf(kls)===-1){this.__set("class",(curr+" "+kls).trim())}
                        }
                        ,enumerable:true
                    },
                    dataset:{get:function(){
                       ...
                       ODF(this,"dataset",{value:nu,writable:false,enumerable:true,configurable:true})
                        return nu;
                    },
                        set:_noop,enumerable:true,configurable:true
                    },
                    classList:{get:function(){
                       ...
                       ODF(this,"classList",{value:nu,writable:false,enumerable:true,configurable:true})
                        return nu;
                    },
                        set:_noop,enumerable:true,configurable:true
                    },
                    ...
                    style:{get:function(){
                       ...
                       ODF(this,"style",{value:nu,writable:false,enumerable:true,configurable:true})
                        return nu
                    },
                        set:_noop,enumerable:true,configurable:true
                    }
            ...
            Element.prototype.querySelector = function(sel){
                if(!sel || !this.__inst_){return null}
            ...
            Element.prototype.getElementsByTagName = function(tag){
                if(!tag || !this.__inst_){return null}
            ...
            Element.prototype.getElementsByClassName = function(kls){
                if(!kls || !this.__inst_){return null}
            ...
            _registerScoped("document",document)
            Node.prototype.ownerDocument=document;
            Node.prototype.lang="";
            Node.prototype.baseURI="";
            Node.prototype.namespaceURI= "http://www.w3.org/1999/xhtml";
            [_noop,Event,EventTarget,DefaultView,Document,DOMTokenList,Attr,DOMStringMap,NamedNodeMap,NodeList,
                HTMLCollection,CSSStyleDeclaration,queryAll,traverse,Node,TextElement,Element].forEach(function(it){
                    _registerScoped(it)
                });
            $exports.util=util;
            return $exports;
        }
     return function  (scope,selecorengine,globals/*...*/) {
            var exports=DOMImpl.apply(this,arguments)
            var execScope=(function( execscope){
                return function(code){
                    var __,__str="("+code.toString()+")"
                    if(typeof(code)=="function"){__str=__str+"()"}
                    with(execscope){
                        __=eval(__str)
                    }; 
                    return __;
